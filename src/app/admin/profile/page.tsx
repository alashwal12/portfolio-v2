        ...
        <form action={updateProfile} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              {profile?.image && (
                <div className="mb-3">
                  <img src={profile.image} alt="Profile" className="w-20 h-20 rounded-full object-cover border border-gray-200 dark:border-gray-700" />
                </div>
              )}
            ...
            <div className="col-span-2 md:col-span-1">
              ...
              {profile?.resumeUrl && (
                <div className="mb-3">
                  <a href={profile.resumeUrl} target="_blank" rel="noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline text-sm font-medium">
                    View Current Resume
                  </a>
                </div>
              )}
